...
namespace dpg_slam {
	 ...
	 */
 	std::unordered_map<std::pair<int, int>, bool, pair_hash> gridInfo;
    };
	...
	/**
	 * number of latest nodes to be taken from current pose chain for getting the local submap.
	 */
	const uint32_t kMaxCurrNodesForLocalSubmap_ = 10;
